namespace ContosoUniversityNow.Migrations
{
    using ContosoUniversityNow.Models;
    ...
    DbMigrationsConfiguration<ContosoUniversityNow.DAL.SchoolContext>
    {
        ...
        Seed(ContosoUniversityNow.DAL.SchoolContext context)
        {
            ...
            foreach (Enrollment e in enrollments)
            {
                ...
                {
                    context.Enrollments.AddOrUpdate(e);
                }
            }
            context.SaveChanges();
        }
